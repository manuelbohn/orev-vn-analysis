...
saveRDS(rasch_fit_mode_fit, "../saves/rasch_fit_mode_fit.rds")

rasch_fit_mode_fit <- readRDS("../saves/rasch_fit_mode_fit.rds")
```
...
# )%>%add_criterion(c("loo","waic")) 
# 
# saveRDS(irt2_c, "../saves/irt2_c.rds")
# 
# irt2_c <- readRDS("../saves/irt2_c.rds")
```

```{r}
#loo_compare(irt1_c, irt2_c)
```
